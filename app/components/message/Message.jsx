    ...
    return (
        <section className={styles.message}>
            <div className={styles.message__main}>
                <h2 className={styles.message__main__h2}>
                    食事提供の負担を減らして<br />
                    本格レシピ×栄養バランスを実現
                </h2>
                <p className={styles.message__main__p}>
            ...
            <div className={styles.message__container}>
                {items.map((item, index) => {
                    return (
                        <div key={index} className={styles.message__container__inner}>
                            <h3 className={styles.message__container__inner__h3}>
                                {item.headline}
                            </h3>
                            <p className={styles.message__container__inner__p}>
                                {item.description}
                            </p>
                        </div>
                    )
